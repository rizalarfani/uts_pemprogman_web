            ...
            <div class="col-lg-10">
                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        ...
                        <h3 class="profile-username text-center"><?php echo $isi->name_karyawan; ?></h3>
                        <p class="text-muted text-center"><?php echo $isi->nama ?></p>
                        ...
                        <a href="<?php echo base_url('karyawan') ?>" class="btn btn-primary btn-block"><b>Kembali</b></a>
                    </div>
                    <!-- /.card-body -->
                </div>
                <!-- /.card -->
